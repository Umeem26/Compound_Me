...
class $TransactionsTable extends Transactions
  ...
  static const VerificationMeta _habitLogIdMeta =
      const VerificationMeta('habitLogId');
  @override
  late final GeneratedColumn<int> habitLogId = GeneratedColumn<int>(
      'habit_log_id', aliasedName, true,
      type: DriftSqlType.int,
      requiredDuringInsert: false,
      defaultConstraints:
          GeneratedColumn.constraintIsAlways('REFERENCES habit_logs (id)'));
  @override
  List<GeneratedColumn> get $columns =>
      [id, amount, date, note, categoryId, walletId, habitLogId];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
    ...
    if (data.containsKey('habit_log_id')) {
      context.handle(
          ...
          habitLogId.isAcceptableOrUnknown(
              data['habit_log_id']!, _habitLogIdMeta));
    }
    return context;
  }
  ...
  Transaction map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Transaction(
      ...
      habitLogId: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}habit_log_id']),
    );
  }
...
class Transaction extends DataClass implements Insertable<Transaction> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || habitLogId != null) {
      map['habit_log_id'] = Variable<int>(habitLogId);
    }
    return map;
  }
  ...
  factory Transaction.fromJson(Map<String, dynamic> json,
    ...
    return Transaction(
      ...
      habitLogId: serializer.fromJson<int?>(json['habitLogId']),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'habitLogId': serializer.toJson<int?>(habitLogId),
    };
  }
  ...
  Transaction copyWith(
          ...
          int? categoryId,
          int? walletId,
          Value<int?> habitLogId = const Value.absent()}) =>
      Transaction(
        id: id ?? this.id,
  ...
  Transaction copyWithCompanion(TransactionsCompanion data) {
    return Transaction(
      ...
      habitLogId:
          data.habitLogId.present ? data.habitLogId.value : this.habitLogId,
    );
  }
  ...
  @override
  int get hashCode =>
      Object.hash(id, amount, date, note, categoryId, walletId, habitLogId);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class TransactionsCompanion extends UpdateCompanion<Transaction> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (habitLogId.present) {
      map['habit_log_id'] = Variable<int>(habitLogId.value);
    }
    return map;
  }
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  List<DatabaseSchemaEntity> get allSchemaEntities =>
      [wallets, categories, habits, habitLogs, transactions];
}
...
final class $$HabitLogsTableReferences
  ...
  static MultiTypedResultKey<$TransactionsTable, List<Transaction>>
      _transactionsRefsTable(_$AppDatabase db) =>
          MultiTypedResultKey.fromTable(db.transactions,
              aliasName: $_aliasNameGenerator(
                  db.habitLogs.id, db.transactions.habitLogId));

  $$TransactionsTableProcessedTableManager get transactionsRefs {
    final manager = $$TransactionsTableTableManager($_db, $_db.transactions)
        .filter((f) => f.habitLogId.id.sqlEquals($_itemColumn<int>('id')!));
          ...
          prefetchHooksCallback: ({habitId = false, transactionsRefs = false}) {
            return PrefetchHooks(
              ...
              getPrefetchedDataCallback: (items) async {
                return [
                  if (transactionsRefs)
                    await $_getPrefetchedData<HabitLog, $HabitLogsTable,
                            Transaction>(
                        currentTable: table,
                        referencedTable: $$HabitLogsTableReferences
                            ._transactionsRefsTable(db),
                        managerFromTypedResult: (p0) =>
                            $$HabitLogsTableReferences(db, table, p0)
                                .transactionsRefs,
                        referencedItemsForCurrentItem:
                            (item, referencedItems) => referencedItems
                                .where((e) => e.habitLogId == item.id),
                        typedResults: items)
                ];
              },
            );
...
final class $$TransactionsTableReferences
  ...
  static $HabitLogsTable _habitLogIdTable(_$AppDatabase db) =>
      db.habitLogs.createAlias(
          $_aliasNameGenerator(db.transactions.habitLogId, db.habitLogs.id));

  $$HabitLogsTableProcessedTableManager? get habitLogId {
    final $_column = $_itemColumn<int>('habit_log_id');
...
class $$TransactionsTableTableManager extends RootTableManager<
    ...
    Transaction,
    PrefetchHooks Function({bool categoryId, bool walletId, bool habitLogId})> {
  $$TransactionsTableTableManager(_$AppDatabase db, $TransactionsTable table)
      : super(TableManagerState(
          ...
          prefetchHooksCallback: (
              {categoryId = false, walletId = false, habitLogId = false}) {
            return PrefetchHooks(
              db: db,
              ...
              addJoins: <
                ...
                if (habitLogId) {
                  state = state.withJoin(
                    ...
                    referencedTable:
                        $$TransactionsTableReferences._habitLogIdTable(db),
                    referencedColumn:
                        $$TransactionsTableReferences._habitLogIdTable(db).id,
                  ) as T;
                }
